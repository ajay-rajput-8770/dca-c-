...
public:
    ...
    {
        int emp_id = stoi(id); //string to int convert karta he
...
int main()
{
    ...
    do
    {
        ...
        cout << "2. Display Employee Salary"<<endl;
        cout << "3. Enter Manager Details"<<endl;
        cout << "4. Display Manager Salary"<<endl;
        cout << "5. Exit"<<endl;
        cout << "Enter choice: ";
        cin >> choice;
